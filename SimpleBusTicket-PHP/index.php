    ...
    <div id="block">
        ...
        <section id="about">
            <div>
                <h1>About Us</h1>
                <p>
                    This web application is build using PHP and MySql. Simple Bus Ticket Booking System is used to
                </p>
            </div>
        </section>
        <section id="contact">
        ...
        <footer>
        <p>
                        <i class="far fa-copyright"></i> <?php echo date('Y');?> - Simple Bus Ticket Booking System | Made with &#10084;&#65039; 
                        </p>
        </footer>
    </div>
